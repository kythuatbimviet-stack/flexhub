...
import { Plus, Trash2, FileText, User, DollarSign, Package, Ruler, Tag, Search } from 'lucide-react'
...
const quotationSchema = z.object({
    ...
    items: z.array(quoteItemSchema).min(1, 'Vui lòng thêm ít nhất 1 dòng'),
...
export function CreateQuotationDialog({ onSuccess }: CreateQuotationDialogProps) {
    ...
    async function onSubmit(values: QuotationFormValues) {
        ...
        try {
            ...
            toast.error(error.message || 'Lỗi khi tạo báo giá')
        } finally {
            setLoading(false)
        }
    }
                ...
                <div className="bg-gradient-to-br from-blue-600 to-indigo-700 p-8 text-white">
                    <DialogHeader>
                        ...
                        <DialogDescription className="text-blue-100 text-base">
                            Tạo bản chào giá chuyên nghiệp cho khách hàng.
                        </DialogDescription>
                    </DialogHeader>
                </div>
                ...
                <Form {...form}>
                    <form onSubmit={form.handleSubmit(onSubmit)} className="p-8 space-y-8">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        ...
                                        <Select onValueChange={field.onChange} defaultValue={field.value}>
                                            <FormControl>
                                                <SelectTrigger className="rounded-2xl bg-gray-50 border-gray-100 h-12 focus:ring-blue-500">
                            ...
                            />
                            <div className="flex flex-col justify-end bg-blue-50/50 p-4 rounded-2xl border border-blue-100/50">
                                <span className="text-xs font-bold text-blue-600 uppercase tracking-widest mb-1">Tổng cộng (Tạm tính)</span>
                                <h2 className="text-3xl font-black text-blue-900">${grandTotal.toLocaleString()}</h2>
                            </div>
                        </div>
                        ...
                        <div className="space-y-4">
                            <div className="flex items-center justify-between border-b border-gray-100 pb-4">
                                ...
                                <Button
                                    ...
                                    className="rounded-full px-4 h-10 font-bold text-indigo-600 border-indigo-200 hover:bg-indigo-50"
                                >
                                        ...
                                        <div className="grid grid-cols-12 gap-6 items-start">
                                            ...
                                            <div className="col-span-12 md:col-span-4">
                                                <FormField
                                                    ...
                                                    render={({ field }) => (
                                                        <FormItem>
                                                            <FormLabel className="text-[10px] font-bold uppercase text-gray-400">Chọn Sản phẩm / Tấm</FormLabel>
                                                            <Select
                                                                onValueChange={(val) => {
                                                                    field.onChange(val)
                                            ...
                                            <div className="col-span-6 md:col-span-2">
                                                <FormField
                                                    ...
                                                    render={({ field }) => (
                                                        <FormItem>
                                                            <FormLabel className="text-[10px] font-bold uppercase text-gray-400">Số lượng / Diện tích</FormLabel>
                                                            <FormControl>
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    <FormLabel className="text-sm font-bold text-gray-900">Ghi chú báo giá</FormLabel>
                                    <FormControl>
                                        <textarea
                                            {...field}
                                            className="w-full min-h-[100px] rounded-2xl border-gray-100 bg-gray-50/50 p-4 focus:ring-blue-500 focus:border-blue-500 transition-all outline-none text-sm"
                                            placeholder="Điều khoản thanh toán, thời gian giao hàng..."
                                        />
                                    </FormControl>
                                    <FormMessage />
                                </FormItem>
                        ...
                        <DialogFooter className="pt-8 border-t border-gray-100 gap-4">
                            ...
                            <Button type="submit" disabled={loading} className="rounded-2xl px-12 h-12 bg-indigo-600 hover:bg-indigo-700 text-white font-black shadow-xl shadow-indigo-100 transition-all active:scale-95">
                                {loading ? 'Đang xử lý...' : 'Xác nhận Báo giá'}
                            </Button>
                        </DialogFooter>
                    </form>
                </Form>
