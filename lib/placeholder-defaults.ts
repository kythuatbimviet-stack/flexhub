...
export const DEFAULT_PLACEHOLDERS: {
    ...
    sort_order: number
        ...
        { key: '{{legal_representative}}', label: 'Người đại diện PL (Bên B)', description: 'Người đại diện pháp luật của Khách hàng', category: 'member', sample_value: 'NGUYỄN VĂN AN', is_active: true, is_default: true, sort_order: 95 },
        { key: '{{representative_phone}}', label: 'SĐT đại diện PL (Bên B)', description: 'SĐT người đại diện pháp luật của Khách hàng', category: 'member', sample_value: '0901 234 567', is_active: true, is_default: true, sort_order: 96 },
        // Trung tâm
        ...
        { key: '{{package_price}}', label: 'Giá gói trước giảm', description: 'Giá niêm yết gói tập trước khi giảm giá (VND)', category: 'package', sample_value: '15.000.000 ₫', is_active: true, is_default: true, sort_order: 370 },
        { key: '{{package_price_words}}', label: 'Giá gói trước giảm (chữ)', description: 'Giá niêm yết gói tập bằng chữ tiếng Việt', category: 'package', sample_value: 'Mười lăm triệu', is_active: true, is_default: true, sort_order: 380 },
        { key: '{{discounted_price}}', label: 'Giá gói trợ giá', description: 'Giá gói tập sau khi áp dụng chương trình trợ giá', category: 'package', sample_value: '12.000.000 ₫', is_active: true, is_default: true, sort_order: 390 },
        { key: '{{discounted_price_words}}', label: 'Giá gói trợ giá (chữ)', description: 'Giá trợ giá bằng chữ tiếng Việt', category: 'package', sample_value: 'Mười hai triệu', is_active: true, is_default: true, sort_order: 400 },
        // Hợp đồng
