...
export const DEFAULT_PLACEHOLDERS: {
    ...
    // Trung tâm
    { key: '{{center_name}}',           label: 'Tên trung tâm',        description: 'Tên đầy đủ của trung tâm',                    category: 'center',   sample_value: 'TRUNG TÂM EVA FIT',        is_active: true, is_default: true, sort_order: 110 },
    { key: '{{center_short_name}}',     label: 'Tên viết tắt TT',      description: 'Tên viết tắt trung tâm',                      category: 'center',   sample_value: 'EVA FIT',                  is_active: true, is_default: true, sort_order: 120 },
