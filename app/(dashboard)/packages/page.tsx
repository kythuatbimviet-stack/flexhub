        ...
        <div className="space-y-8 max-w-[1600px] mx-auto font-inter pb-10">
            ...
            <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-6 px-1">
                <div className="space-y-1">
                    <h1 className="text-3xl font-semibold tracking-tight text-slate-900 dark:text-white">Gói tập</h1>
                    <p className="text-sm text-slate-500 dark:text-slate-400 font-medium">Danh mục các gói dịch vụ và chương trình tập luyện của Lady Fit.</p>
                </div>
                    ...
                    <div className="flex flex-col xl:flex-row gap-4 justify-between items-center">
                        ...
                        <div className="flex flex-wrap items-center gap-3 w-full xl:w-auto">
                            <Select value={filterBranch} onValueChange={setFilterBranch}>
                                <SelectTrigger className="w-full sm:w-[180px] rounded-xl border-2 border-slate-100 dark:border-slate-800 h-11 bg-white dark:bg-slate-950 text-xs font-medium">
                    ...
                    <Table>
                        <TableHeader className="bg-slate-50/50 dark:bg-slate-900/50">
                            <TableRow className="border-slate-100 dark:border-slate-800 hover:bg-transparent">
                                ...
                                <TableHead className="font-semibold text-slate-500 dark:text-slate-400 text-xs py-6">Gói tập & Mã</TableHead>
                                <TableHead className="font-semibold text-slate-500 dark:text-slate-400 text-xs">Chi nhánh</TableHead>
                                <TableHead className="font-semibold text-slate-500 dark:text-slate-400 text-xs">Phân loại</TableHead>
                                <TableHead className="font-semibold text-slate-500 dark:text-slate-400 text-xs text-right">Giá niêm yết</TableHead>
