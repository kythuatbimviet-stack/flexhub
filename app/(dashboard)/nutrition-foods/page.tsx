...
export default function NutritionFoodsPage() {
    ...
    const exportToExcel = () => {
        ...
        const data = foods.map((f: any) => ({
            ...
            'Fiber': f.fiber || 0,
            '\u0110\u01a1n v\u1ecb': f.unit || '',
            'H\u1ec7 s\u1ed1 chuy\u1ec3n \u0111\u1ed5i': f.conversion_factor || 1,
            '\u1ea2nh': f.image_base64 || '',
        }))
        ...
        toast.success(`\u0110\u00e3 xu\u1ea5t ${data.length} th\u1ef1c ph\u1ea9m`)
    }
            ...
            <Card className="border-none shadow-sm rounded-xl overflow-visible bg-white dark:bg-gray-900 transition-all duration-300">
                <div className="p-3 flex flex-wrap items-center gap-3">
                    <div className="relative flex-1 min-w-[300px]">
                        ...
                        <Input
                            placeholder="Tìm kiếm tên thực phẩm hoặc nhóm..."
                            value={searchTerm}
                    ...
                    <div className="flex items-center gap-2">
                        <Select value={categoryFilter} onValueChange={setCategoryFilter}>
                            <SelectTrigger className="w-[180px] h-10 rounded-xl border-slate-200 dark:border-slate-800">
                                    ...
                                    <TableRow key={f.id} className={cn("border-gray-50 dark:border-gray-800 hover:bg-gray-50/50 dark:hover:bg-gray-800/50 transition-colors group", selectedIds.includes(f.id) && "bg-red-50/30 dark:bg-red-900/10")}>
                                        ...
                                        <TableCell className="py-4">
                                            {f.image_base64 ? (
                                                ...
                                                <div className="w-10 h-10 rounded-lg bg-slate-50 dark:bg-slate-800 flex items-center justify-center border border-slate-100 dark:border-slate-800">
