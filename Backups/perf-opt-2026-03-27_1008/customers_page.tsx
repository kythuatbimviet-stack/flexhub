                ...
                <div className="p-4 border-b border-gray-100 dark:border-gray-800 flex flex-col lg:flex-row gap-4 justify-between bg-gray-50/50 dark:bg-gray-800/20">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <Button
                            ...
                            className="rounded-xl border border-emerald-100 dark:border-emerald-900/30 text-emerald-600 dark:text-emerald-400 h-11 px-3 sm:px-4 hover:bg-emerald-50 dark:hover:bg-emerald-950/20 hover:text-emerald-700 dark:hover:text-emerald-300 transition-all font-medium"
                        >
